...
final class CreateTrackerViewController: UIViewController {
    ...
    private lazy var regularHabitButton: UIButton = {
        ...
        regularHabitButton.setTitle(NSLocalizedString("regularHabit.title", comment: "Regular habit button"), for: .normal)
    ...
    private lazy var singleTrackerButton: UIButton = {
        ...
        singleTrackerButton.setTitle(NSLocalizedString("singleTracker.title", comment: "Single tracker button"), for: .normal)
    ...
    private func setupNavigationBar() {
        ...
        navigationBar.topItem?.title = NSLocalizedString("createTrackers.title", comment: "Tracker creation title")
    }
