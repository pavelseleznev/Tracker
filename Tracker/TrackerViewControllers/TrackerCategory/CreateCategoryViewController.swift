...
final class CreateCategoryViewController: UIViewController {
    ...
    private lazy var categoryNameField: UITextField = {
        ...
        categoryNameField.placeholder = NSLocalizedString("categoryNameField.placeholder", comment: "Category name field placeholder")
        ...
        categoryNameField.backgroundColor = AppColor.ypBackgroundColor
    ...
    private lazy var createCategoryButton: UIButton = {
        ...
        createCategoryButton.setTitle(NSLocalizedString("doneButton.title", comment: "Done Button title"), for: .normal)
        ...
        createCategoryButton.setTitleColor(.white, for: .disabled)
    ...
    private func setupNavigationBar() {
        ...
        navigationBar.topItem?.title = NSLocalizedString("newCategory.title", comment: "New category")
    }
