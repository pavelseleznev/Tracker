...
final class EditingCategoryViewController: UIViewController {
    ...
    private lazy var saveCategoryButton: UIButton = {
        ...
        saveCategoryButton.setTitle(NSLocalizedString("doneButton.title", comment: "Done Button title"), for: .normal)
        saveCategoryButton.setTitleColor(AppColor.ypWhite, for: .normal)
        saveCategoryButton.setTitleColor(.white, for: .disabled)
    ...
    override func viewDidLoad() {
        ...
        setupConstraints()
        tapToHideKeyboard()
        textFieldDidChangeSelection(categoryNameField)
    }
    ...
    private func createNavigationBar() {
        ...
        navigationBar.topItem?.title = NSLocalizedString("editingCategory.title", comment: "Editing a category")
    }
