...
final class ListOfCategoriesViewController: UIViewController {
    ...
    private lazy var placeholderLabel: UILabel = {
        ...
        placeholderLabel.text = NSLocalizedString("placeholderLabel", comment: "No trackers placeholder label")
    ...
    private lazy var createCategoryButton: UIButton = {
        ...
        createCategoryButton.setTitle(NSLocalizedString("addCategoryButton.title", comment: "Add category button title"), for: .normal)
    ...
    private func setupNavigationBar() {
        ...
        navigationBar.topItem?.title = NSLocalizedString("category.title", comment: "Category title")
    }
...
extension ListOfCategoriesViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        categoryCell.backgroundColor = AppColor.ypBackgroundColor
        ...
        if indexPath.row != trackerCategoryTitle.count - 1 {
            createSeparatorImageView(cell: categoryCell)
        }
...
extension ListOfCategoriesViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, contextMenuConfigurationForRowAt indexPath: IndexPath, point: CGPoint) -> UIContextMenuConfiguration? {
        let configuration = UIContextMenuConfiguration(identifier: nil, previewProvider: nil) { _ in
            let editAction = UIAction(title: NSLocalizedString("edit", comment: "edit"), image: nil) { [weak self] _ in
                ...
                editingCategoryViewController.editingIndex = indexPath.row
                
                let navigationViewController = UINavigationController(rootViewController: editingCategoryViewController)
                self.present(navigationViewController, animated: true)
            }
            
            let deleteAction = UIAction(title: NSLocalizedString("delete", comment: "Delete category confirmation"), image: nil, attributes: .destructive) { [weak self] _ in
                guard let self = self else { return }
                
                let alert = UIAlertController(title: NSLocalizedString("deleteCategory.confirmation", comment: "Delete category question"), message: nil, preferredStyle: .actionSheet)
                alert.addAction(UIAlertAction(title: NSLocalizedString("cancel", comment: "Cancel category deletion"), style: .cancel, handler: nil))
                alert.addAction(UIAlertAction(title: NSLocalizedString("delete", comment: "Delete category confirmation"), style: .destructive, handler: { _ in
