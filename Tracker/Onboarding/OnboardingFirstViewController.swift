...
final class OnboardingFirstViewController: UIViewController {
    ...
    private lazy var textLabel: UILabel = {
        ...
        textLabel.text = NSLocalizedString("onboardingBlue.title", comment: "OnboardingBlue title")
    ...
    private  lazy var continueButton: UIButton = {
        ...
        continueButton.setTitle(NSLocalizedString("onboardingButton.title", comment: "Onboarding continue button"), for: .normal)
